...
router.get("/:courseId/materials/:materialId/edit", Controller.editMaterialsForm);
...
router.get("/:courseId/materials/:materialId/delete", Controller.deleteMaterials);

router.get("/:courseId/materials/:materialId/finish", Controller.finishMaterials);

router.get("/:courseId/materials/:materialId/undo", Controller.undoMaterials);
